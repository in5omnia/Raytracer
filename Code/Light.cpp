...
void PointLight::sampleLight(const Vector3& referencePoint, std::default_random_engine& rng,
...
Color PointLight::getIntensity(const Vector3& intersectionPoint, const Vector3& lightPosition, const Vector3& lightNormal) const {
	return intensity;
}
