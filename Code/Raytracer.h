...
class Raytracer {
	...
	public:
		...
		Color computeDirectLighting(const Vector3& intersectionPoint,
									const Vector3& normal,
									const Vector3& viewDir,
									const Material& material,
									std::default_random_engine& rng);

		Color microfacetBRDF(const Vector3& viewDir,
							 const Vector3& reflected,
							 const Vector3& normal,
							 const Material& material) const;

		float microfacetPDF(const Vector3& viewDir,
							const Vector3& reflected,
							const Vector3& normal,
							const Material& material);
/*
...
*/
		...
		float computeGGXPDF(const Vector3& viewDir, const Vector3& sampledDir,
							const Vector3& normal, const Material& material);

		Color evaluateBRDF(const Material& material,
						   const Vector3& viewDir,
		...
		void orthonormalBasis(const Vector3& normal,
							  Vector3& tangent,
							  Vector3& bitangent);
